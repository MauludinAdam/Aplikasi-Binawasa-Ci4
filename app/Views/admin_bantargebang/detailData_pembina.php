    ...
    <div class="card card-outline card-success">
        <div class="card-header" style="background:#800080;">
            ...
            <div class="card-tools">
                <a href="/Admin_bantargebang/pembina_bantar_gebang" class="btn btn-success "><i class="fas fa-backward"></i> Kembali</a>
            </div>
        </div>
        <div class="card-body">
        <div class="row ">
        <div class="col-sm-4">
            <div class="card shadow mt-2" style="height:97%;">
                <img src="/ijazah/<?= $bantargebang['ijazah'] ?>" width="100%" class="card-img-top" alt="...">
            </div>
        </div>
        <div class="col-md-8">
        ...
        <div class="col-sm-12 mt-3">
            ...
            <div class="form-group row">
                ...
                <span class="mt-2 ml-2">:</span>
                <div class="col-sm-8">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?= $bantargebang['nama'] ?>">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <span class="mt-2 ml-2">:</span>
                <div class="col-sm-8">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?= $bantargebang['thn_lulus_kmd'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <span class="mt-2 ml-2">:</span>
                <div class="col-sm-8">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?= $bantargebang['thn_lulus_kml'] ?>">
                </div>
            </div>
            <div class="form-group row">
