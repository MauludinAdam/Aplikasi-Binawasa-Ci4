...
?>
    <?php echo form_open_multipart('/Admin_bantargebang/ubahData_pelatih/'. $bantargebang['idpelatih_bantargebang']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                ...
                <div class="row">
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $bantargebang['nta'] ?>" placeholder="Masukkan Nta Pembina">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="number" name="no_gudep" class="form-control" value="<?= $bantargebang['no_gudep'] ?>" placeholder="Masukkan No Gudep">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="nama" class="form-control" value="<?= $bantargebang['nama'] ?>" placeholder="Nama Lengkap">
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="jenkel" class="form-control" value="<?= old('jenkel'); ?>">
                                    ...
                                    <option value="Laki-Laki" <?= $bantargebang['jenkel'] == 'Laki-Laki' ? 'selected' : '' ?>>Laki-Laki</option>
                                    <option value="Perempuan" <?= $bantargebang['jenkel'] == 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="text" name="tempat_lhr" class="form-control" value="<?= $bantargebang['tempat_lhr'] ?>" placeholder="Tempat Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="date" name="tgl_lhr" class="form-control" value="<?= $bantargebang['tgl_lhr'] ?>" placeholder="Tempat Tgl Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="email" name="email" class="form-control" value="<?= $bantargebang['email'] ?>" placeholder="Masukkan Email">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="number" name="no_telp" class="form-control" value="<?= $bantargebang['no_telp'] ?>" placeholder="No Telp">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="pangkalan" class="form-control" value="<?= $bantargebang['pangkalan'] ?>" placeholder="Pangkalan">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KPD" <?= $bantargebang['kualifikasi'] == 'KPD' ? 'selected' : '' ?>>KPD</option>
                                        <option value="KPL" <?= $bantargebang['kualifikasi'] == 'KPL' ? 'selected' : '' ?>>KPL</option>
                                    </select>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="golongan" class="form-control" value="<?= old('golongan'); ?>">
                                        ...
                                        <option value="Pandega" <?= $bantargebang['golongan'] == 'Pandega' ? 'selected' : '' ?>>Pandega</option>
                                        <option value="Penggalang" <?= $bantargebang['golongan'] == 'Penggalang' ? 'selected' : '' ?>>Penggalang</option>
                                        <option value="Penegak" <?= $bantargebang['golongan'] == 'Penegak' ? 'selected' : '' ?>>Penegak</option>
                                        <option value="Siaga" <?= $bantargebang['golongan'] == 'Siaga' ? 'selected' : '' ?>>Siaga</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    <label for="thn_lulus_kpd" class="mt-3">Tahun Lulus KMD<span class="text-danger">*</span></label>
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= $bantargebang['thn_lulus_kpd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    <label for="thn_lulus_kpl" class="mt-3">Tahun Lulus KML<span class="text-danger">*</span></label>
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= $bantargebang['thn_lulus_kpl'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <textarea name="alamat" class="form-control" cols="3" rows="6"><?= $bantargebang['alamat'] ?></textarea>
