...
?>
    <?php echo form_open_multipart('/Admin_bantargebang/ubahData_pembina/'. $bantargebang['idpembina_bantargebang']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KMD" <?= $bantargebang['kualifikasi'] == 'KMD' ? 'selected' : '' ?>>KMD</option>
                                        <option value="KML" <?= $bantargebang['kualifikasi'] == 'KML' ? 'selected' : '' ?>>KML</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kmd" class="form-control" value="<?= $bantargebang['thn_lulus_kmd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kml" class="form-control" value="<?= $bantargebang['thn_lulus_kml'] ?>" placeholder="Nama Lengkap">
