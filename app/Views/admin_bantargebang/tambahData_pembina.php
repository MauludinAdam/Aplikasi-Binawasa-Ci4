...
?>
    <?php echo form_open_multipart('/Admin_bantargebang/insertData_pembina'); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kmd" class="form-control" value="<?= old('thn_lulus_kmd'); ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kml" class="form-control" value="<?= old('thn_lulus_kml'); ?>" placeholder="Nama Lengkap">
