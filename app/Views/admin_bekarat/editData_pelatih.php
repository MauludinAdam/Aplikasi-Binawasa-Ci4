...
?>
    <?php echo form_open_multipart('/Admin_bekarat/ubahData_pelatih/'. $bekarat['idpelatih_bekarat']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                ...
                <div class="row">
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $bekarat['nta'] ?>" placeholder="Masukkan Nta Pelatih">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="number" name="no_gudep" class="form-control" value="<?= $bekarat['no_gudep'] ?>" placeholder="Masukkan No Gudep">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="nama" class="form-control" value="<?= $bekarat['nama'] ?>" placeholder="Nama Lengkap">
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="jenkel" class="form-control" value="<?= old('jenkel'); ?>">
                                    ...
                                    <option value="Laki-Laki" <?= $bekarat['jenkel'] == 'Laki-Laki' ? 'selected' : '' ?>>Laki-Laki</option>
                                    <option value="Perempuan" <?= $bekarat['jenkel'] == 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="text" name="tempat_lhr" class="form-control" value="<?= $bekarat['tempat_lhr'] ?>" placeholder="Tempat Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="date" name="tgl_lhr" class="form-control" value="<?= $bekarat['tgl_lhr'] ?>" placeholder="Tempat Tgl Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="email" name="email" class="form-control" value="<?= $bekarat['email'] ?>" placeholder="Masukkan Email">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="number" name="no_telp" class="form-control" value="<?= $bekarat['no_telp'] ?>" placeholder="No Telp">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="pangkalan" class="form-control" value="<?= $bekarat['pangkalan'] ?>" placeholder="Pangkalan">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KPD" <?= $bekarat['kualifikasi'] == 'KPD' ? 'selected' : '' ?>>KPD</option>
                                        <option value="KPL" <?= $bekarat['kualifikasi'] == 'KPL' ? 'selected' : '' ?>>KPL</option>
                                    </select>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="golongan" class="form-control" value="<?= old('golongan'); ?>">
                                        ...
                                        <option value="Pandega" <?= $bekarat['golongan'] == 'Pandega' ? 'selected' : '' ?>>Pandega</option>
                                        <option value="Penggalang" <?= $bekarat['golongan'] == 'Penggalang' ? 'selected' : '' ?>>Penggalang</option>
                                        <option value="Penegak" <?= $bekarat['golongan'] == 'Penegak' ? 'selected' : '' ?>>Penegak</option>
                                        <option value="Siaga" <?= $bekarat['golongan'] == 'Siaga' ? 'selected' : '' ?>>Siaga</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= $bekarat['thn_lulus_kpd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= $bekarat['thn_lulus_kpl'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <textarea name="alamat" class="form-control" cols="3" rows="6"><?= $bekarat['alamat'] ?></textarea>
