...
?>
    <?php echo form_open_multipart('/Admin_bekarat/ubahData_pembina/'. $bekarat['idpembina_bekasibarat']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                    ...
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $bekarat['nta'] ?>" placeholder="Masukkan Nta Pembina">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KMD" <?= $bekarat['kualifikasi'] == 'KMD' ? 'selected' : '' ?>>KMD</option>
                                        <option value="KML" <?= $bekarat['kualifikasi'] == 'KML' ? 'selected' : '' ?>>KML</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kmd" class="form-control" value="<?= $bekarat['thn_lulus_kmd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kml" class="form-control" value="<?= $bekarat['thn_lulus_kml'] ?>" placeholder="Nama Lengkap">
