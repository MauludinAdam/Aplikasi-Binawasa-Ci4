...
?>
    <?php echo form_open_multipart('/Admin_bekasilatan/ubahData_pembina/'. $bekasilatan['idpembina_bekasilatan']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KMD" <?= $bekasilatan['kualifikasi'] == 'KMD' ? 'selected' : '' ?>>KMD</option>
                                        <option value="KML" <?= $bekasilatan['kualifikasi'] == 'KML' ? 'selected' : '' ?>>KML</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kmd" class="form-control" value="<?= $bekasilatan['thn_lulus_kmd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kml" class="form-control" value="<?= $bekasilatan['thn_lulus_kml'] ?>" placeholder="Nama Lengkap">
