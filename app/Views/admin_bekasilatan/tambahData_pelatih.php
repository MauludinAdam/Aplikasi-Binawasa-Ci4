...
?>
    <?php echo form_open_multipart('/Admin_bekasilatan/insertData_pelatih'); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                    <h3 class="text-center">Input Data Pembina</h3>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <div class="row">
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= old('nta'); ?>" placeholder="Masukkan Nta Pelatih">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="date" name="tgl_lhr" class="form-control" value="<?= old('tgl_lhr'); ?>" placeholder="Tempat Tgl Lahir">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= old('thn_lulus_kpd'); ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= old('thn_lulus_kpl'); ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <textarea name="alamat" class="form-control" cols="3" rows="6"><?= old('alamat'); ?></textarea>
