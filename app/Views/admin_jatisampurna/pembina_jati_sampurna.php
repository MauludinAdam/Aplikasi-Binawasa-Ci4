    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
              <a href="/Admin_jatisampurna/excelData_pembina" class="btn btn-outline-success shadow ml-2 float-right"><i class="fas fa-file-excel"></i> Excel</a>
               <a href="/Admin_jatisampurna/tambahData_pembina" class="btn btn-info shadow ml-3"><i class="fas fa-plus-square"></i> Tambah Data</a>
                ...
                <tbody>
                    ...
                    foreach($jatisampurna as $value) : ?>
                        <tr>
                            ...
                            <td>
                              <a href="/Admin_jatisampurna/detailData_pembina/<?= $value['slug'] ?>" class="btn btn-secondary"><i class="fas fa-info-circle"></i> Detail</a>
                            </td>
                            <td>
                            <a href="/Admin_jatisampurna/downloadData_pembina/<?= $value['idpembina_jatisampurna']; ?>" class="btn btn-info"><i class="fas fa-download"></i> Download</a>
                            </td>
                            <td width="20%">
                                <a href="/Admin_jatisampurna/editData_pembina/<?= $value['slug']; ?>" class="btn btn-success"><i class="fas fa-pencil-square"></i> Edit</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/Admin_jatisampurna/deleteData_pembina/<?= $value['idpembina_jatisampurna'] ?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
