...
?>
    <?php echo form_open_multipart('/Admin_mustikajaya/ubahData_pelatih/'. $mustikajaya['idpelatih_mustikajaya']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                    ...
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $mustikajaya['nta'] ?>" placeholder="Masukkan Nta Pelatih">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KPD" <?= $mustikajaya['kualifikasi'] == 'KPD' ? 'selected' : '' ?>>KPD</option>
                                        <option value="KPL" <?= $mustikajaya['kualifikasi'] == 'KPL' ? 'selected' : '' ?>>KPL</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= $mustikajaya['thn_lulus_kpd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= $mustikajaya['thn_lulus_kpl'] ?>" placeholder="Nama Lengkap">
