...
?>
    <?php echo form_open_multipart('/Admin_pondokgede/ubahData_pelatih/'. $pondokgede['idpelatih_pondokgede']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                ...
                <div class="row">
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $pondokgede['nta'] ?>" placeholder="Masukkan Nta Pembina">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="number" name="no_gudep" class="form-control" value="<?= $pondokgede['no_gudep'] ?>" placeholder="Masukkan No Gudep">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="nama" class="form-control" value="<?= $pondokgede['nama'] ?>" placeholder="Nama Lengkap">
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="jenkel" class="form-control" value="<?= old('jenkel'); ?>">
                                    ...
                                    <option value="Laki-Laki" <?= $pondokgede['jenkel'] == 'Laki-Laki' ? 'selected' : '' ?>>Laki-Laki</option>
                                    <option value="Perempuan" <?= $pondokgede['jenkel'] == 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="text" name="tempat_lhr" class="form-control" value="<?= $pondokgede['tempat_lhr'] ?>" placeholder="Tempat Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="date" name="tgl_lhr" class="form-control" value="<?= $pondokgede['tgl_lhr'] ?>" placeholder="Tempat Tgl Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="email" name="email" class="form-control" value="<?= $pondokgede['email'] ?>" placeholder="Masukkan Email">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="number" name="no_telp" class="form-control" value="<?= $pondokgede['no_telp'] ?>" placeholder="No Telp">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="pangkalan" class="form-control" value="<?= $pondokgede['pangkalan'] ?>" placeholder="Pangkalan">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KMD" <?= $pondokgede['kualifikasi'] == 'KMD' ? 'selected' : '' ?>>KMD</option>
                                        <option value="KML" <?= $pondokgede['kualifikasi'] == 'KML' ? 'selected' : '' ?>>KML</option>
                                    </select>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="golongan" class="form-control" value="<?= old('golongan'); ?>">
                                        ...
                                        <option value="Pandega" <?= $pondokgede['golongan'] == 'Pandega' ? 'selected' : '' ?>>Pandega</option>
                                        <option value="Penggalang" <?= $pondokgede['golongan'] == 'Penggalang' ? 'selected' : '' ?>>Penggalang</option>
                                        <option value="Penegak" <?= $pondokgede['golongan'] == 'Penegak' ? 'selected' : '' ?>>Penegak</option>
                                        <option value="Siaga" <?= $pondokgede['golongan'] == 'Siaga' ? 'selected' : '' ?>>Siaga</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= $pondokgede['thn_lulus_kpd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= $pondokgede['thn_lulus_kpl'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <textarea name="alamat" class="form-control" cols="3" rows="3"><?= $pondokgede['alamat'] ?></textarea>
