...
?>
    <?php echo form_open_multipart('/Admin_pondokgede/ubahData_pembina/'. $pondokgede['idpembina_pondokgede']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kmd" class="form-control" value="<?= $pondokgede['thn_lulus_kmd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kml" class="form-control" value="<?= $pondokgede['thn_lulus_kml'] ?>" placeholder="Nama Lengkap">
