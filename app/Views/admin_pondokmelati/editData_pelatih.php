...
?>
    <?php echo form_open_multipart('/Admin_pondokmelati/ubahData_pelatih/'. $pondokmelati['idpelatih_pondokmelati']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KPL" <?= $pondokmelati['kualifikasi'] == 'KPL' ? 'selected' : '' ?>>KPL</option>
                                        <option value="KPD" <?= $pondokmelati['kualifikasi'] == 'KPD' ? 'selected' : '' ?>>KPD</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= $pondokmelati['thn_lulus_kpl'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= $pondokmelati['thn_lulus_kpd'] ?>" placeholder="Nama Lengkap">
