...
?>
    <?php echo form_open_multipart('/Admin_pondokmelati/ubahData_pembina/'. $pondokmelati['idpembina_pondokmelati']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                ...
                <div class="row">
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $pondokmelati['nta'] ?>" placeholder="Masukkan Nta Pembina">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="number" name="no_gudep" class="form-control" value="<?= $pondokmelati['no_gudep'] ?>" placeholder="Masukkan No Gudep">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="nama" class="form-control" value="<?= $pondokmelati['nama'] ?>" placeholder="Nama Lengkap">
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="jenkel" class="form-control" value="<?= old('jenkel'); ?>">
                                    ...
                                    <option value="Laki-Laki" <?= $pondokmelati['jenkel'] == 'Laki-Laki' ? 'selected' : '' ?>>Laki-Laki</option>
                                    <option value="Perempuan" <?= $pondokmelati['jenkel'] == 'Perempuan' ? 'selected' : '' ?>>Perempuan</option>
                                </select>
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="text" name="tempat_lhr" class="form-control" value="<?= $pondokmelati['tempat_lhr'] ?>" placeholder="Tempat Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="date" name="tgl_lhr" class="form-control" value="<?= $pondokmelati['tgl_lhr'] ?>" placeholder="Tempat Tgl Lahir">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="email" name="email" class="form-control" value="<?= $pondokmelati['email'] ?>" placeholder="Masukkan Email">
                    ...
                    <tr>
                            <td>
                                ...
                                <input type="number" name="no_telp" class="form-control" value="<?= $pondokmelati['no_telp'] ?>" placeholder="No Telp">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="pangkalan" class="form-control" value="<?= $pondokmelati['pangkalan'] ?>" placeholder="Pangkalan">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KMD" <?= $pondokmelati['kualifikasi'] == 'KMD' ? 'selected' : '' ?>>KMD</option>
                                        <option value="KML" <?= $pondokmelati['kualifikasi'] == 'KML' ? 'selected' : '' ?>>KML</option>
                                    </select>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="golongan" class="form-control" value="<?= old('golongan'); ?>">
                                        ...
                                        <option value="Pandega" <?= $pondokmelati['golongan'] == 'Pandega' ? 'selected' : '' ?>>Pandega</option>
                                        <option value="Penggalang" <?= $pondokmelati['golongan'] == 'Penggalang' ? 'selected' : '' ?>>Penggalang</option>
                                        <option value="Penegak" <?= $pondokmelati['golongan'] == 'Penegak' ? 'selected' : '' ?>>Penegak</option>
                                        <option value="Siaga" <?= $pondokmelati['golongan'] == 'Siaga' ? 'selected' : '' ?>>Siaga</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kmd" class="form-control" value="<?= $pondokmelati['thn_lulus_kmd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kml" class="form-control" value="<?= $pondokmelati['thn_lulus_kml'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <textarea name="alamat" class="form-control" cols="3" rows="3"><?= $pondokmelati['alamat'] ?></textarea>
