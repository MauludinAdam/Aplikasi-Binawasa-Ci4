...
?>
    <?php echo form_open_multipart('/Admin_rawalumbu/ubahData_pelatih/'. $rawalumbu['idpelatih_rawalumbu']); ?>
    <?= csrf_field(); ?>
        <table align="center">
            <tr>
                <td>
                    ...
                    <div class="form-group">
                        <tr>
                            <td>
                                ...
                                <input type="number" name="nta" class="form-control" value="<?= $rawalumbu['nta'] ?>" placeholder="Masukkan Nta Pelatih">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select name="kualifikasi" class="form-control" value="<?= old('kualifikasi'); ?>">
                                        ...
                                        <option value="KPD" <?= $rawalumbu['kualifikasi'] == 'KPD' ? 'selected' : '' ?>>KPD</option>
                                        <option value="KPL" <?= $rawalumbu['kualifikasi'] == 'KPL' ? 'selected' : '' ?>>KPL</option>
                                    </select>
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpd" class="form-control" value="<?= $rawalumbu['thn_lulus_kpd'] ?>" placeholder="Nama Lengkap">
                        ...
                        <div class="form-group">
                            <tr>
                                <td>
                                    ...
                                    <input type="date" name="thn_lulus_kpl" class="form-control" value="<?= $rawalumbu['thn_lulus_kpl'] ?>" placeholder="Nama Lengkap">
