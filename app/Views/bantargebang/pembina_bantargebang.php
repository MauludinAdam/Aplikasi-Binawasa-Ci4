    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
              <a href="/Bantargebang/excelData_pembina" class="btn btn-outline-success shadow ml-2 float-right"><i class="fas fa-file-excel"></i> Excel</a>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach($bantargebang as $value) : ?>
                        <tr>
                            ...
                            <td>
                              <a href="/Bantargebang/detailData_pembina/<?= $value['slug'] ?>" class="btn btn-secondary"><i class="fas fa-info-circle"></i> Detail</a>
                            </td>
                            <td>
                            <a href="/Bantargebang/downloadData_pembina/<?= $value['idpembina_bantargebang']; ?>" class="btn btn-info"><i class="fas fa-download"></i> Download</a>
                            </td>
                            <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/Bantargebang/deleteData/<?= $value['idpembina_bantargebang'] ?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
