    ...
    <div class="card card-outline card-success">
        <div class="card-header" style="background:#800080;">
            ...
            <div class="card-tools">
                <a href="/Mustikajaya/pelatih_mustikajaya" class="btn btn-success "><i class="fas fa-backward"></i> Kembali</a>
            </div>
        </div>
        <div class="card-body">
        <div class="row ">
        <div class="col-sm-4">
            <div class="card shadow mt-2">
                <img src="/ijazah/<?= $mustikajaya['ijazah'] ?>" width="100%" class="card-img-top mb-4" alt="...">
            </div>
        </div>
        <div class="col-md-8">
        ...
        <div class="col-sm-12 mt-3">
            ...
            <div class="form-group row">
                ...
                <span class="mt-2 ml-2">:</span>
                <div class="col-sm-8">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?= $mustikajaya['thn_lulus_kpd'] ?>">
                </div>
            </div>
            <div class="form-group row">
                ...
                <span class="mt-2 ml-2">:</span>
                <div class="col-sm-8">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?= $mustikajaya['thn_lulus_kpl'] ?>">
                </div>
            </div>
            <div class="form-group row">
