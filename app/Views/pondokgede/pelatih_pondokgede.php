    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
              <a href="/Pondokgede/excelData_pelatih" class="btn btn-outline-success shadow ml-2 float-right"><i class="fas fa-file-excel"></i> Excel</a>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach($pondokgede as $value) : ?>
                        <tr>
                            ...
                            <td>
                              <a href="/Pondokgede/detailData_pelatih/<?= $value['slug'] ?>" class="btn btn-secondary"><i class="fas fa-info-circle"></i> Detail</a>
                            </td>
                            <td>
                            <a href="/Pondokgede/downloadData_pelatih/<?= $value['idpelatih_pondokgede']; ?>" class="btn btn-info"><i class="fas fa-download"></i> Download</a>
                            </td>
                            <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/Pondokgede/deletePelatih/<?= $value['idpelatih_pondokgede'] ?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
