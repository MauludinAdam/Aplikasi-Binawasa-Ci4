    ...
    <div class="card card-outline card-success">
        <div class="card-header">
            ...
            <div class="card-tools">
              <a href="/Rawalumbu/excelData_pembina" class="btn btn-outline-success shadow ml-2 float-right"><i class="fas fa-file-excel"></i> Excel</a>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach($rawalumbu as $value) : ?>
                        <tr>
                            ...
                            <td>
                              <a href="/Rawalumbu/detailData_pembina/<?= $value['slug'] ?>" class="btn btn-secondary"><i class="fas fa-info-circle"></i> Detail</a>
                            </td>
                            <td>
                            <a href="/Rawalumbu/downloadData_pembina/<?= $value['idpembina_rawalumbu']; ?>" class="btn btn-info"><i class="fas fa-download"></i> Download</a>
                            </td>
                            <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/Rawalumbu/deleteData/<?= $value['idpembina_rawalumbu'] ?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
